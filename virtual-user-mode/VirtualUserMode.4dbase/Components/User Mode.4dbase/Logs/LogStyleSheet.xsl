            ...
            <body>
                <div id="header">
                    ...
                    <table id="summary">
                        ...
                        <tr>
                            <td><xsl:text>Strukturdatei:</xsl:text></td>
                            <td><xsl:value-of select="@structure" /></td>
                        </tr>
                        <tr>
                            <td><xsl:text>Datendatei:</xsl:text></td>
						...
						<tr>
							<td><xsl:text>Ende: </xsl:text></td>
							<td><xsl:value-of select="@time" />
							<xsl:if test="@user_canceled = 'true'">
								<xsl:text>, </xsl:text>
								<b class="canceled"><xsl:text>Abbruch durch Anwender</xsl:text></b>
								</xsl:if>
							</td>
                     	</tr>
                        </xsl:for-each>
                    ...
                    <ul id="menu">
                        <li>
                            <a href="#" onclick="showAll();"><xsl:text>Alle anzeigen</xsl:text></a><xsl:text> / </xsl:text><a href="#" onclick="hideAll();"><xsl:text>Alle ausblenden</xsl:text></a>
                        </li>
                        <li>
                            <a href="#" onclick="showErrorsOrWarnings('error');"><xsl:text>Fehler anzeigen</xsl:text></a><xsl:text> / </xsl:text><a href="#" onclick="hideErrorsOrWarnings('error');"><xsl:text>Fehler ausblenden</xsl:text></a>
                        </li>
                        <li>
                            <a href="#" onclick="showErrorsOrWarnings('warning');"><xsl:text>Warnungen anzeigen</xsl:text></a><xsl:text> / </xsl:text><a href="#" onclick="hideErrorsOrWarnings('warning');"><xsl:text>Warnungen ausblenden</xsl:text></a>
                        </li>
                    </ul>
                </div>
    ...
    <xsl:template name="displayMainStep">
        ...
        <xsl:for-each select="move">
            <div class="SubTitle">
                <table class="Error">
                    <tr>
                        <td><b><xsl:text>Quelle : </xsl:text></b></td>
                        <td><xsl:value-of select="@from" /></td>
                    </tr>
                    <tr>
                        <td><b><xsl:text>Ziel : </xsl:text></b></td>
    ...
    <xsl:template name="displayStep">
        ...
        <div class="operation">
            ...
            <xsl:for-each select="move">
                <table class="move">
                    <tr>
                        <td><xsl:text>Quelle:</xsl:text></td>
                        <td><xsl:value-of select="@from" /></td>
                    </tr>
                    <tr>
                        <td><xsl:text>Ziel:</xsl:text></td>
                        <td><xsl:value-of select="@to" /></td>
                    </tr>
                </table>		
            </xsl:for-each>
